...
type PropsContainerHome = {
	index: number;
	heigth: string;
};

type IPropsParams = PropsContainerHome & Props;
...
const changeColorButton = (props: IPropsParams) => {
...
const ContainerSection = (props: IPropsParams) => {
	const {
		index,
		heigth,
		theme: {
...
export const ContainerHome = styled.section<PropsContainerHome>`
	width: 100%;
