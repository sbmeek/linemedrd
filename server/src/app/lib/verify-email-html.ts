...
<table style="border-collapse: collapse; margin: auto;">
	...
	margin: auto; margin-bottom: 20px; font-size: 1.17em; font-weight: bold;">Hola <span style="color: #66d2bc;">${name}
					${lastname}</span>,</div>
			<div style="max-width: 80%; margin: auto;">
				<p>Su registro en <span style="color: #66d2bc; font-weight: bold;">LineMedRD</span> está casi completado.
					Acceda al siguiente enlace para finalizar el proceso y verificar su cuenta.</p>
			</div>
